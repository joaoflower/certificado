...
?>
	<table border="0" cellpadding="0" cellspacing="0">
	  ...
	  <a href="" title="Retroceder" class="linkboton" onClick = "grd_selectplan('<?=$_SESSION["sEstunum_mat"]?>', '<?=$_SESSION["sEstucod_car"]?>'); return false"><img src="../images/bback.png" width="100" height="24"></a>
	  <a href="" title="Continuar" class="linkboton" onClick = "grd_viewnota<?=$_SESSION["sPor"]?>(); return false"><img src="../images/bcontinue.png" width="100" height="24"></a>
<?
	}
?>