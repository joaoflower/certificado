...
<script language="JavaScript" src="../js/grados.js"></script>
...
<table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="tcontent">
  <tr id="trcontent">
    <td width="90" valign="top" id="tdsubmenu">
	  <div id="dsubmenu">
	  	<div class="dcelmenu"><a href="" onClick="clickhistoacad(); return false;">Historial Acad.</a></div>
		<div class="dcelmenu"><a href="" onClick="clickcerplan(); return false;">Certif. y Plan</a></div>
	  </div>	
