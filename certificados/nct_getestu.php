...
<table border="0" cellpadding="0" cellspacing="0" id="ventana">
  ...
  <tr>
    ...
    <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table border="0" cellpadding="1" cellspacing="0" class="tabled">
      ...
      <tr>
        <th class="wordizq	">&nbsp;</th>
        <th class="wordizq	"><input name="rNum_mat" type="text" id="rNum_mat" size="6" maxlength="6"  onBlur="nct_versearch(this);" >
              </span></th>
        <th class="wordizq"><input name="rPaterno" type="text" id="rPaterno" onBlur="nct_versearch(this);" size="20" maxlength="20" ></th>
        <th class="wordizq"><input name="rMaterno" type="text" id="rMaterno" size="20" maxlength="20" onBlur="nct_versearch(this);" ></th>
        <th class="wordizq"><input name="rNombres" type="text" class="texto" id="rNombres" size="25" maxlength="30" onBlur="nct_versearch(this);" ></th>
        <th class="wordizq">&nbsp;</th>
      </tr>
      <tr>
