...
<script language="JavaScript" src="../js/certificado.js"></script>
  ...
  <tr id="trcontent">
    <td width="90" valign="top" id="tdsubmenu">
	  <div id="dsubmenu">
		...
		<div class="dcelmenu"><a href="" onClick="clicknewcerti(); return false;">Nuevo Certif</a></div>
		<div class="dcelmenu"><a href="" onClick="clicksearchcerti(); return false;">Buscar Certif. </a></div>
	  </div>	
