...
<?
	...
	if($bData)	
	{
			...
			$vCod_car == '56' or $vCod_car == '65' or $vCod_car == '66')
		{
			...
			for($vAno_aca = '2008'; $vAno_aca >= $vAno_ini and !$bUltmat; $vAno_aca--)
			{
	...
	<table border="0" cellpadding="0" cellspacing="0" id="ventana">
        ...
        <tr>
          ...
          <td background="../images/ventana_r2_c2.jpg" class="wordcen"><table border="1" cellpadding="1" cellspacing="0" bordercolor="#BDD37B" rules="cols, rows" class="tabled">            
			...
			<tr>
			  <td class="wordder">Recibo N&deg; : </td>
			  <td class="tdcampo">&nbsp;<input name="rNum_rec" type="text" id="rNum_rec" size="12" maxlength="12" ></td>
		    </tr>
			<tr>
			  <td class="wordder">Tipo de Certificado : </td>
			  <td class="tdcampo"><input name="rTip_cer" type="radio" value="1" checked="checked" />
			    Certificado de Egresado | 
			      <input name="rTip_cer" type="radio" value="2" />
		      Certificado de Estudiante  </td>
		    </tr>
			<tr>
              <td width="100" class="wordder">Plan de Estudios : </td>
              <td width="450" class="tdcampo">&nbsp;<select name="rPln_est" id="rPln_est" onChange="nct_viewespecial(this.value)">
		...
		{
		?>
	  <a href="" title="Continuar" class="linkboton" onClick = "nct_selectnivsem(); return false"><img src="../images/bcontinue.png" width="100" height="24"></a> 
<?
		}
	}
	/*
