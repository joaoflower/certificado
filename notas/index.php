...
<table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="tcontent">
  <tr id="trcontent">
    <td width="90" valign="top" id="tdsubmenu">
	  <div id="dsubmenu">
	  	<div class="dcelmenu"><a href="" onClick="clickpormatri(); return false;">Por Matricula </a></div>
		<div class="dcelmenu"><a href="" onClick="clickporplan(); return false;">Por Plan </a></div>
	  </div>	
	  <div id="dsubmessage">Bienvenidos</div>
	</td>
    <td valign="top" id="tdsubcontent">
	  <div id="dsubcontent">Bienvenido a Un@p.Net2 </div>	</td>
  </tr>
</table>    
</div>
